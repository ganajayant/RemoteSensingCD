...
import models
from models.ChangeFormer import (ChangeFormerV1, ChangeFormerV2,
                                 ChangeFormerV3, ChangeFormerV4,
...
class ResNet(torch.nn.Module):
    def __init__(self, input_nc, output_nc,
        ...
        self.classifier = TwoLayerConv2d(
            in_channels=32, out_channels=output_nc)
    ...
    def __init__(self, input_nc, output_nc, with_pos, resnet_stages_num=5,
        ...
        if with_pos == 'learned':
            self.pos_embedding = nn.Parameter(
                torch.randn(1, self.token_len*2, 32))
